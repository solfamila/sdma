...
void SMARTDMA_CODE EZHB_PIOControl(void);
...
void keep_smartdma_api_alive(void)
{
	...
	//g_SMARTDMA_api[0] = (void (*)(void))(((uint32_t)EZHB_PIOControl + 4) & (~3U));
#ifdef EZHB_TX      
    g_SMARTDMA_api[0] = (void (*)(void))(((uint32_t)EZHB_I3CWriting + 4) & (~3U));
#else    
    g_SMARTDMA_api[0] = (void (*)(void))(((uint32_t)EZHB_I3CReading + 4) & (~3U));
#endif    
    (void)ptr;
}
